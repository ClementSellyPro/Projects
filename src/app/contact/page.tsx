    ...
    <div className="md:pl-20 lg:pr-20px pr-5px px-5 py-8  bg-slate-50 relative">
      <div className="flex justify-between items-center py-8 mr-8 mb-6 border-b bg-slate-50 sticky top-0">
        <h1 className="md:text-4xl text-2xl font-semibold">
          Contacter <strong className="text-kalipro">KALIPRO</strong>
        </h1>

        {isNumberDisplay ? (
          <ClickablePhone phoneNumber="0692 041262" />
        ) : (
          <button
            onClick={() => setIsNumberDisplay(true)}
            className="py-2 px-6 rounded-full border border-kalipro hover:bg-kalipro text-kalipro hover:text-white w-fit"
          >
            Nous appeler
          </button>
        )}
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            name="mail"
            type="text"
            placeholder="julienpayet@mail.com"
