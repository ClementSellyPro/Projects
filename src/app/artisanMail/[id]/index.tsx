...
const ArtisanMail = ({ params, data }: paramsType) => {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    const newMessage = {
      ...
      phone: phone,
      message: message,
      artisan: selectedArtisan[0]?.name,
    ...
    <div className="md:px-20 px-5 py-8 bg-slate-50">
      <div className="flex justify-between pb-5 border-b">
        <h1 className="text-4xl font-base">
          ...
          <strong className="text-blueKalipro">
            {" "}
            {selectedArtisan[0]?.name}
          </strong>
        </h1>
      </div>
      ...
      <form
        ...
        className="flex flex-col md:gap-10 gap-8 md:w-7/12 mt-5 w-full"
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <input
            ...
            name="mail"
            type="email"
            placeholder="johnpayet@mail.com"
        ...
        <div className="flex flex-col gap-1">
          ...
          <textarea
            ...
            name="message"
            placeholder="Bonjour, je recherches un artisan afin de réaliser ..."
            required
          />
        </div>
